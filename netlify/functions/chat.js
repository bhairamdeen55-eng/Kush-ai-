...
// Secure proxy for text + vision chat (with Free/Pro quota)
const { initStore, canUse, recordUsage, resolveApiModel, modelIdFor } = require('./_shared/quota');
...
exports.handler = async (event) => {
  ...
  // modelId (guru5) + model (apiModel) dono accept karo
